...
/**
 * print_magic - Prints the magic numbers of n ELF header.
...
/**
 * print_type - Prints the entry of an ELF header.
 * @e_entry: The address of the ELF entry point.
 * @e_ident: A  pointer to an array containing the ELF class.
 */

void point_entry(unsigned long int e_entry, unsigned char *e_ident)
{
 ...
 * Return: 0 on success.
 *
 * Description: If the file is not ELF file or the function fails
 *		- exit code 98.
 */
